      ...
      <Layout>
        <main className="container sebcontent">
          ...
          <section className="row mt-4">
            <div className="col-xs-12">
              <p>My first camera was a <a href="https://www.flickr.com/photos/95742794@N05/27370388280/in/pool-camerawiki/" target="_blank">Yashica automatic</a>, which my father gave me when I was 4-5 years old. Then I got an upgrade to <a href="http://camera-wiki.org/wiki/Yashica_Samurai_X3.0" target="_blank">Yasica SLR</a> when I turned into a teenagar, in which he taught me about setting up focus. My father was an avid portrait photographer, he captured all beautiful moments in our family and shared his passion with me. Initially I took a lot of really bad photos but he developed them even when he was working in UAE and then send the developed pictures via airmail to my little town in South India. These picture had his thoughts behind them, these thoughts helped me shape as a photographer and then I grew into capturing people in their moments.</p>
